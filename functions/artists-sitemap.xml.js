// Cloudflare Pages Function: GET /artists-sitemap.xml
//
// Serves the artist-pages sitemap under artwhisper.app (same host as the URLs it
...
export async function onRequestGet() {
  try {
    ...
    const res = await fetch(`${API_BASE}/v1/sitemap/artists.xml`, {
